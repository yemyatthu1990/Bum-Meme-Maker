...
/**
 * A TextView that resize it's text to be no larger than the width of the view.
 *
...
public class AutofitTextView  extends TextView {
  ...
  private void init(Context context, AttributeSet attrs, int defStyle) {
    ...
    if (attrs != null) {
      TypedArray ta =
          context.obtainStyledAttributes(attrs, R.styleable.AutofitTextView, defStyle, 0);
   ...
   */
  private static float getTextSize(String text, TextPaint paint, float targetWidth, int maxLines,
